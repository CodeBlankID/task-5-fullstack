...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $posval=[
            ...
            [
                "title"=>"Testing 4",
                "content"=>"There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as ne",
                "category_id"=>"2",
                "user_id"=> "2"
            ],
            [
        ...
        foreach ($posval as $valuepos) {
            Post::create($valuepos);
        }
